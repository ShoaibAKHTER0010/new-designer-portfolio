...
const Navbar = () => {
  ...
  return (
    <div className='w-full  sticky top-0 z-50  backdrop-blur-lg   left-0'>
      ...
      <div className="text-gray-950 text-[22px] font-medium font-['DM Sans'] underline leading-[24px] md:leading-[30px] flex gap-3 py-4 md:py-0"><img src="./images/mail.png" alt="img-1" className='inline' /><h2 className='py-3'> hi@arif.interactive</h2></div>
